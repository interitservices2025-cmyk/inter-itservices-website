...
export const portfolio: Project[] = [
  {
    ...
    businessValue: {
      en: "Centralization of quote requests via an interactive interface, eliminating manual booking processes, and growing local customer acquisition in Ontario.",
      fr: "Centralisation des demandes de devis via une interface interactive, élimination des processus manuels de réservation par courriel et augmentation significative de l'acquisition de clients locaux en Ontario.",
    },
    projectLink: "https://qc-entretienservices.ca",
  ...
  },
  {
    ...
    businessValue: {
      en: "Showcasing work quality through optimized image galleries, improving client conversion during on-site visits using branded print folders, and empowering the team to manage their project updates.",
      fr: "Valorisation de la qualité des réalisations grâce à des galeries d'images optimisées, amélioration de la conversion lors des rendez-vous physiques à l'aide des dossiers imprimés de marque, et autonomisation de l'équipe pour ajouter de nouveaux projets.",
    },
    projectLink: "https://trireno.ca",
  ...
  },
  {
    ...
    businessValue: {
      en: "Full automation of workshop registrations, secure online payment processing for equipment, and centralized order tracking, freeing up hours of weekly administrative overhead.",
      fr: "Automatisation complète des inscriptions aux ateliers, traitement sécurisé des paiements en ligne pour le matériel et centralisation du suivi des commandes, libérant ainsi des dizaines d'heures de gestion administrative hebdomadaire.",
    },
    projectLink: "https://mmegasports.com",
  ...
  },
  {
    ...
    businessValue: {
      en: "Securing confidential audit report transfers, enhancing brand professionalism with enterprise accounts, and implementing a unified brand identity across all business deliverables.",
      fr: "Sécurisation des transferts de rapports d'audit confidentiels, renforcement de la perception de professionnalisme auprès des grands comptes, et mise en place d'une identité visuelle unifiée pour tous les livrables d'affaires.",
    },
    projectLink: "https://intersolutions.ca",
